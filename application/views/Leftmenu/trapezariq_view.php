...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="products">
                <ul>
                    <?php foreach ($trapezariq as $trapezariqq): ?>
                        <li>
                            <?php echo form_open('promociq/addspalnq'); ?>
                            <div class="name"><?php echo $trapezariqq->name; ?></div>
                            <div class="thumb">
                                <?php
                                echo img(array(
                                    'src' => 'images/' . $trapezariqq->image,
                                    'class' => 'thumb',
                                    'alt' => $trapezariqq->name
                                ));
                                ?>				
                            </div>
                            <div class="price"><?php echo $trapezariqq->content; ?></div>
