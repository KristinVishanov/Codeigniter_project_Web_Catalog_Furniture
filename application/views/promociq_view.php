...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="products">
                <ul>
                    <?php foreach ($products as $product): ?>
                        <li>
                            <?php echo form_open('promociq/add'); ?>
                            ...
                            <div class="price"><?php echo $product->content; ?></div>
            ...
            <div class="footer"><img class="footerimageradius"  src="<?= base_url() ?>css/images/footer.jpg" alt="footer" />
